...
class VoiceTest(object):
    ...
    def __init__(self, id=None, audio_uri=None, text_uri=None, last_action_date_time=None, status=None, created_date_time=None, model=None, voice_test_kind=None):  # noqa: E501
