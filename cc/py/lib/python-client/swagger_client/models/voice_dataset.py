...
class VoiceDataset(object):
    ...
    def __init__(self, id=None, data_import_kind=None, name=None, description=None, properties=None, locale=None, last_action_date_time=None, status=None, created_date_time=None):  # noqa: E501
        """VoiceDataset - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this VoiceDataset.  # noqa: E501

        The identifier of this entity.  # noqa: E501

        :return: The id of this VoiceDataset.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this VoiceDataset.

        The identifier of this entity.  # noqa: E501

        :param id: The id of this VoiceDataset.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def data_import_kind(self):
        """Gets the data_import_kind of this VoiceDataset.  # noqa: E501

        The kind of the dataset (e.g. acoustic data, language data ...)  # noqa: E501

        :return: The data_import_kind of this VoiceDataset.  # noqa: E501
        :rtype: str
        """
    ...
    def data_import_kind(self, data_import_kind):
        """Sets the data_import_kind of this VoiceDataset.

        The kind of the dataset (e.g. acoustic data, language data ...)  # noqa: E501

        :param data_import_kind: The data_import_kind of this VoiceDataset.  # noqa: E501
        :type: str
        """
        if data_import_kind is None:
            raise ValueError("Invalid value for `data_import_kind`, must not be `None`")  # noqa: E501
        allowed_values = ["None", "Language", "Acoustic", "Pronunciation", "CustomVoice", "AudioFiles"]  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this VoiceDataset.  # noqa: E501

        The name of the object.  # noqa: E501

        :return: The name of this VoiceDataset.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this VoiceDataset.

        The name of the object.  # noqa: E501

        :param name: The name of this VoiceDataset.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this VoiceDataset.  # noqa: E501

        The description of the object.  # noqa: E501

        :return: The description of this VoiceDataset.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this VoiceDataset.

        The description of the object.  # noqa: E501

        :param description: The description of this VoiceDataset.  # noqa: E501
        :type: str
        """
    ...
    @property
    def properties(self):
        """Gets the properties of this VoiceDataset.  # noqa: E501
        ...
        :return: The properties of this VoiceDataset.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def properties(self, properties):
        """Sets the properties of this VoiceDataset.

        The custom properties of this entity. The maximum allowed key length is 64 characters, the maximum  allowed value length is 256 characters and the count of allowed entries is 10.  # noqa: E501

        :param properties: The properties of this VoiceDataset.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def locale(self):
        """Gets the locale of this VoiceDataset.  # noqa: E501

        The locale of the contained data.  # noqa: E501

        :return: The locale of this VoiceDataset.  # noqa: E501
        :rtype: str
        """
        return self._locale
    ...
    def locale(self, locale):
        """Sets the locale of this VoiceDataset.

        The locale of the contained data.  # noqa: E501

        :param locale: The locale of this VoiceDataset.  # noqa: E501
        :type: str
        """
        if locale is None:
    ...
    def last_action_date_time(self):
        """Gets the last_action_date_time of this VoiceDataset.  # noqa: E501
        ...
        :return: The last_action_date_time of this VoiceDataset.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_action_date_time(self, last_action_date_time):
        """Sets the last_action_date_time of this VoiceDataset.

        The time-stamp when the current status was entered.  The time stamp is encoded as ISO 8601 date and time format  (\"YYYY-MM-DDThh:mm:ssZ\", see https://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations).  # noqa: E501

        :param last_action_date_time: The last_action_date_time of this VoiceDataset.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def status(self):
        """Gets the status of this VoiceDataset.  # noqa: E501

        The status of the object.  # noqa: E501

        :return: The status of this VoiceDataset.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this VoiceDataset.

        The status of the object.  # noqa: E501

        :param status: The status of this VoiceDataset.  # noqa: E501
        :type: str
        """
    ...
    def created_date_time(self):
        """Gets the created_date_time of this VoiceDataset.  # noqa: E501
        ...
        :return: The created_date_time of this VoiceDataset.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_date_time(self, created_date_time):
        """Sets the created_date_time of this VoiceDataset.

        The time-stamp when the object was created.  The time stamp is encoded as ISO 8601 date and time format  (\"YYYY-MM-DDThh:mm:ssZ\", see https://en.wikipedia.org/wiki/ISO_8601#Combined_date_and_time_representations).  # noqa: E501

        :param created_date_time: The created_date_time of this VoiceDataset.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VoiceDataset, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceDataset):
            return False
